...
import com.july.doc.format.Format;
import com.july.doc.framework.Framework;
import com.july.doc.model.ApiDoc;
import com.july.doc.model.ApiModule;
import com.july.doc.resolver.DocTagResolver;
import com.july.doc.resolver.JavaSourceFileManager;
import com.july.doc.resolver.javaparser.JavaParserDocTagResolver;
...
public class JulyDoc {
     ...
     *
     * @see com.july.doc.resolver.javaparser.JavaParserDocTagResolver
     */
    @Setter
     ...
     * @param srcDir 源码目录路径
     */
    public JulyDoc(File srcDir, Framework framework) {
     ...
     */
    public JulyDoc(List<File> srcDirs, Framework framework) {
